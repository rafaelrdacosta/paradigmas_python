...
print(f'O segundo elemnento da lista é {segundo_elemento}.')

# Adicionando um elemento ao final da lista
lista.append(60)
print(f'Lista após adicionar 60: {lista}')

# Inserinco um elemento em uma posição específica
lista.insert(2, 25) #inserindo 25 na posição 2
print(f'Lista após inserir 25 na posição 2: {lista}')

# Removendo um elemento da lista
lista.remove(40) #revove o primeiro valor 40 encontrado
print(f'Lista após remover 40: {lista}')

# Removendo o último elemeto da lista
